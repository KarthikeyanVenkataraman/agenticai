"""
Purpose  : Extracts all the text from the given text based PDF
@author  : Karthikeyan V
Comments : Typically, aadhar PDF downloaded from UIDAI site are password protected.
so the password is needed to extract the file
"""
